 ...
 */
type ArrayFieldProps<TParent, TKey extends keyof TParent = keyof TParent, TItem = TParent[TKey][number]> = {
 ...
 * @template TItem - The type of each item in the array.
 */
type ArrayFieldApi<TParent, TKey extends keyof TParent = keyof TParent, TItem = TParent[TKey][number]> = ExposedControlProps<TItem[]> & ArrayMethods<TItem> & {
 ...
 */
declare function createArrayField<TParent, TKey extends keyof TParent = keyof TParent, TItem = TParent[TKey][number]>(props: ArrayFieldProps<TParent, TKey, TItem>): ArrayFieldApi<TParent, TKey, TItem>;
/**
 ...
 */
declare function ArrayField<TParent, TKey extends keyof TParent = keyof TParent, TItem = TParent[TKey][number]>(props: ArrayFieldProps<TParent, TKey, TItem> & {
 ...
 */
type FieldProps<TParent, TKey extends keyof TParent = keyof TParent, TValue = TParent[TKey]> = Pick<ControlProps<TValue>, "validate"> & {
    control: Control<TParent>;
    name: TKey;
};
/**
 ...
 * @template TValue - The type of value stored in the field.
 */
type FieldApi<TParent, TKey extends keyof TParent = keyof TParent, TValue = TParent[TKey]> = ExposedControlProps<TValue> & {
 ...
 */
declare function createField<TParent, TKey extends keyof TParent = keyof TParent, TValue = TParent[TKey]>(props: FieldProps<TParent, TKey, TValue>): FieldApi<TParent, TKey, TValue>;
/**
 ...
 */
declare function Field<TParent, TKey extends keyof TParent = keyof TParent, TValue = TParent[TKey]>(props: FieldProps<TParent, TKey, TValue> & {
 ...
 * @template TValue - The type of value stored in the field.
 */
type FieldComponent<TValue> = <TChildKey extends keyof TValue, TChildValue = TValue[TChildKey]>(props: Omit<FieldProps<TValue, TChildKey, TChildValue>, "control"> & {
...
type FormApi<TValue extends object> = ExposedControlProps<TValue> & {
    control: Control<TValue>;
    Field: FieldComponent<TValue>;
    handleSubmit: (onValid?: (value: TValue, control: Control<TValue>) => unknown, onInvalid?: (value: TValue, control: Control<TValue>) => unknown) => Promise<void>;
 ...
 */
declare function minLength<T>(length: number, msg: string, chain?: Validate<string | T[]>): Validate<string | T[]>;
/**
 ...
 * @returns A validation function for strings or arrays.
 */
declare function maxLength<T>(length: number, msg: string, chain?: Validate<string | T[]>): Validate<string | T[]>;
/**
 ...
 */
declare function equals<T>(value: T, msg: string, chain?: Validate<T>): Validate<T>;

declare function registerField<T>(parentControl: Control<T>, name: keyof T, childControl: Control<FieldTypes>): void;
