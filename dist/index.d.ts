 ...
 */
type ArrayFieldProps<TParent, TKey extends keyof TParent = keyof TParent, TItem extends any = TParent[TKey][number]> = {
 ...
 * @template TItem - The type of each item in the array.
 */
type ArrayFieldApi<TParent, TKey extends keyof TParent = keyof TParent, TItem extends any = TParent[TKey][number]> = ExposedControlProps<TItem[]> & ArrayMethods<TItem> & {
 ...
 */
declare function createArrayField<TParent, TKey extends keyof TParent = keyof TParent, TItem extends any = TParent[TKey][number]>(props: ArrayFieldProps<TParent, TKey, TItem>): ArrayFieldApi<TParent, TKey, TItem>;
/**
 ...
 */
declare function ArrayField<TParent, TKey extends keyof TParent = keyof TParent, TItem extends any = TParent[TKey][number]>(props: ArrayFieldProps<TParent, TKey, TItem> & {
 ...
 */
declare function createArrayMethods<TItem>(setValue: Setter<TItem[]>): ArrayMethods<TItem>;
 ...
 */
type FieldProps<TParent, TKey extends keyof TParent = keyof TParent, TValue extends any = TParent[TKey]> = Pick<ControlProps<TValue>, "validate"> & {
    control: Control<TParent>;
    name: TKey;
};
/**
 ...
 * @template TValue - The type of value stored in the field.
 */
type FieldApi<TParent, TKey extends keyof TParent = keyof TParent, TValue extends any = TParent[TKey]> = ExposedControlProps<TValue> & {
 ...
 */
declare function createField<TParent, TKey extends keyof TParent = keyof TParent, TValue extends any = TParent[TKey]>(props: FieldProps<TParent, TKey, TValue>): FieldApi<TParent, TKey, TValue>;
/**
 ...
 */
declare function Field<TParent, TKey extends keyof TParent = keyof TParent, TValue extends any = TParent[TKey]>(props: FieldProps<TParent, TKey, TValue> & {
 ...
 * @template TValue - The type of value stored in the field.
 */
type FieldComponent<TValue> = <TChildKey extends keyof TValue, TChildValue extends unknown = TValue[TChildKey]>(props: Omit<FieldProps<TValue, TChildKey, TChildValue>, "control"> & {
 ...
 */
declare function createFieldComponent<TValue>(control: Control<TValue>): FieldComponent<TValue>;

/**
 * Props for a Form component.
 * @template TValue - The type of the form's initial value object.
 */
type FormProps<TValue extends object> = Pick<ControlProps<TValue>, "validate"> & {
    initialValue: TValue;
...
type FormApi<TValue extends object> = ExposedControlProps<TValue> & {
    control: Control<TValue>;
    Field: FieldComponent<TValue>;
    handleSubmit: (onValid?: (value: TValue) => any, onInvalid?: (control: Control<TValue>) => any) => Promise<void>;
    response: Accessor<any>;
 ...
 */
declare function createForm<TValue extends object>(props: FormProps<TValue>): FormApi<TValue>;
/**
 ...
 */
declare function Form<TValue extends object>(props: FormProps<TValue> & {
    children: (field: FormApi<TValue>) => JSX.Element;
}): JSX.Element;

type Fields<T> = Map<keyof T, Control<any>>;
 ...
 */
declare function required(msg?: string, chain?: Validate<any>): Validate<any>;
/**
 ...
 */
declare function custom<T>(fn: (value: T) => boolean, msg: string, chain?: Validate<T>): Validate<T>;
/**
 ...
 */
declare function minLength(length: number, msg: string, chain?: Validate<string | any[]>): Validate<string | any[]>;
/**
 ...
 * @returns A validation function for strings or arrays.
 */
declare function maxLength(length: number, msg: string, chain?: Validate<string | any[]>): Validate<string | any[]>;
/**
 ...
 */
declare function max(max: number | Date, msg: string, chain?: Validate<number | Date>): Validate<number | Date>;
/**
 ...
 * @returns A validation function for numbers or dates.
 */
declare function min(min: number | Date, msg: string, chain?: Validate<number | Date>): Validate<number | Date>;
/**
 ...
 */
declare function pattern(pattern: RegExp, msg: string, chain?: Validate<string>): Validate<string>;
/**
 ...
 */
declare function equals(value: any, msg: string, chain?: Validate<any>): Validate<any>;

declare function registerField<T>(parentControl: Control<T>, name: keyof T, childControl: Control<any>): void;
declare function unregisterField<T>(parentControl: Control<T>, name: keyof T): void;
declare function getErrorList(control: Control<any>): string[];
declare function getErrorMap<T>(control: Control<T>): Record<keyof T, string> & Record<string, string>;
declare function getInputProps<TParent, TKey extends keyof TParent = keyof TParent>(field: FieldApi<TParent, TKey, string>): ComponentProps<"input">;

export { ArrayField, type ArrayFieldApi, type ArrayFieldProps, type ArrayMethods, type Control, type ControlProps, type ExposedControlProps, Field, type FieldApi, type FieldComponent, type FieldProps, type Fields, type FieldsApi, type FieldsComponent, type ForceLookup, Form, type FormApi, type FormProps, type KeyOf, type Validate, type ValidationMethod, createArrayField, createArrayMethods, createControl, createField, createFieldComponent, createForm, custom, equals, getErrorList, getErrorMap, getInputProps, hiddenControlProps, max, maxLength, min, minLength, pattern, registerField, required, unregisterField };
